...
public class Workspace extends AppWorkspaceComponent {
	...
	dataManager.reset();
	    ...
	    deleteButton.setPrefWidth(BUTTON_TAG_WIDTH);
	    tagToolbar.getChildren().add(deleteButton);

	    // INIT ITS EVENT HANDLER
	    deleteButton.setOnAction(e -> {
		String tagName = deleteButton.getText();
		HTMLTagPrototype clickedTag = dataManager.getTag(tagName);
		pageEditController.handleDeleteElementRequest(clickedTag);
	    });
