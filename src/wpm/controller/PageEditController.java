...
public class PageEditController {
     ...
     * @param element The element to add to the tree.
     */
    public void handleDeleteElementRequest(HTMLTagPrototype element) {
	if (enabled) {
	    Workspace workspace = (Workspace) app.getWorkspaceComponent();
	    ...
	    HTMLTagPrototype selectedTag = (HTMLTagPrototype) selectedItem.getValue();
            ...
            List<String> basicElementList = new ArrayList<String>();
            basicElementList.add("html");
            basicElementList.add("head");
            basicElementList.add("title");
            basicElementList.add("link");
            basicElementList.add("body");
